...
#define RADIO_TRHOTTLE_NEUTRAL 1500
#define RADIO_TRHOTTLE_MIN 800
#define RADIO_TRHOTTLE_MAX 2000
...
\
  _rc.avg_values[RADIO_PITCH] += _ppm[RADIO_PITCH];\
...
\
  tmp_radio = _ppm[RADIO_TRHOTTLE] - RC_PPM_TICKS_OF_USEC(1500);\
  _rc.values[RADIO_TRHOTTLE] = tmp_radio * (tmp_radio >=0 ? (MAX_PPRZ/(float)(RC_PPM_SIGNED_TICKS_OF_USEC(2000-1500))) : (MIN_PPRZ/(float)(RC_PPM_SIGNED_TICKS_OF_USEC(800-1500))));\
  Bound(_rc.values[RADIO_TRHOTTLE], MIN_PPRZ, MAX_PPRZ); \
\
  avg_cpt++;\
...
\
    tmp_radio = _rc.avg_values[RADIO_PITCH] / RC_AVG_PERIOD -  RC_PPM_TICKS_OF_USEC(1500);\
...
\
  ...
  tmp_value = (tmp_radio >=0 ? (tmp_radio *  MAX_PPRZ) / (RC_PPM_SIGNED_TICKS_OF_USEC(2000-1500)) : (tmp_radio * MIN_PPRZ) / (RC_PPM_SIGNED_TICKS_OF_USEC(1000-1500)));\
  Bound(tmp_value, MIN_PPRZ, MAX_PPRZ); \
  _rc.values[RADIO_PITCH] = (pprz_t)((RADIO_FILTER * _rc.values[RADIO_PITCH] + tmp_value) / (RADIO_FILTER + 1));\
\
  tmp_radio = _ppm[RADIO_GEAR] - RC_PPM_TICKS_OF_USEC(1500);\
  tmp_value = (tmp_radio >=0 ? (tmp_radio *  MAX_PPRZ) / (RC_PPM_SIGNED_TICKS_OF_USEC(2000-1500)) : (tmp_radio * MIN_PPRZ) / (RC_PPM_SIGNED_TICKS_OF_USEC(1000-1500)));\
  Bound(tmp_value, MIN_PPRZ, MAX_PPRZ); \
  _rc.values[RADIO_GEAR] = (pprz_t)(tmp_value);\
\
  tmp_radio = _ppm[RADIO_ROLL] - RC_PPM_TICKS_OF_USEC(1500);\
  tmp_value = (tmp_radio >=0 ? (tmp_radio *  MAX_PPRZ) / (RC_PPM_SIGNED_TICKS_OF_USEC(2000-1500)) : (tmp_radio * MIN_PPRZ) / (RC_PPM_SIGNED_TICKS_OF_USEC(1000-1500)));\
  Bound(tmp_value, MIN_PPRZ, MAX_PPRZ); \
...
\
  ...
  Bound(tmp_value, MIN_PPRZ, MAX_PPRZ); \
  _rc.values[RADIO_TRHOTTLE] = (pprz_t)(tmp_value);\
\
}
