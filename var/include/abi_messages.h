...
static inline void AbiBindMsgTEST_ABI(abi_event * ev, abi_callbackTEST_ABI cb) {
  ev->cb = (abi_callback)cb;
  ABI_PREPEND(abi_queues[ABI_TEST_ABI_ID],ev);
}

static inline void AbiSendMsgTEST_ABI(const int8_t value, const struct abi_boo boo, const struct Int32Vect3 * vect) {
  abi_event* e;
