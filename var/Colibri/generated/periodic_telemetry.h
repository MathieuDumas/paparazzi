/* This file has been generated from /home/lionel/paparazziAssembla/vamudes-paparazzi/conf/messages.xml and /home/lionel/paparazziAssembla/vamudes-paparazzi/conf/telemetry/default_fixedwing.xml */
/* Please DO NOT EDIT */
...
#define PERIOD_VAMUDES_AIRSPEED_Ap_0 (0.1)
#define PERIOD_ALIVE_Ap_0 (5)
#define PERIOD_GPS_Ap_0 (0.1)
#define PERIOD_NAVIGATION_Ap_0 (1.)
#define PERIOD_ATTITUDE_Ap_0 (0.5)
#define PERIOD_ESTIMATOR_Ap_0 (0.1)
...
#define PeriodicSendAp(_trans, _dev) {  /* 60Hz */ \
  if (telemetry_mode_Ap == TELEMETRY_MODE_Ap_default) {\
    ...
    if (i6 == 0) {\
      PERIODIC_SEND_VAMUDES_AIRSPEED(_trans, _dev);\
    } \
    if (i6 == 0) {\
...
#define PERIOD_COMMANDS_Fbw_0 (0.25)
#define PERIOD_PPM_Fbw_0 (0.5)
#define PERIOD_FBW_STATUS_Fbw_0 (2)
#define PERIOD_ACTUATORS_Fbw_0 (0.25)
