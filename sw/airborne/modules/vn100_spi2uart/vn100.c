...
#define SPI0_SPIE       (0x00 << 7)  /* Interrupt : Enable */
...
void SS_On(void);
void SS_Off(void);
uint8_t SPITransmit(uint8_t value);
...
void VN100_Init(void){
  ...
  /* setup SPI0 */
  SOSPCR &= !(SPI0_BITENABLE | SPI0_CPHA | SPI0_CPOL | SPI0_MSTR | SPI0_LSBF | SPI0_SPIE | SPI0_BITS);
  S0SPCR |=   SPI0_BITENABLE | SPI0_CPHA | SPI0_CPOL | SPI0_MSTR | SPI0_LSBF | SPI0_SPIE | SPI0_BITS;
  //S0SPCR = 0x0030;
