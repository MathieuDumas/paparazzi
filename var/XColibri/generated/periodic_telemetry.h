/* This file has been generated from /home/lionel/paparazziAssembla/vamudes-paparazzi/conf/messages.xml and /home/lionel/paparazziAssembla/vamudes-paparazzi/conf/telemetry/default_fixedwing_imu_9k6.xml */
/* Please DO NOT EDIT */
...
#define PERIOD_AIRSPEED_Ap_0 (1.4)
#define PERIOD_ALIVE_Ap_0 (5)
#define PERIOD_GPS_Ap_0 (0.5)
#define PERIOD_NAVIGATION_Ap_0 (1.)
#define PERIOD_ATTITUDE_Ap_0 (0.7)
#define PERIOD_ESTIMATOR_Ap_0 (0.6)
#define PERIOD_ENERGY_Ap_0 (2.5)
#define PERIOD_WP_MOVED_Ap_0 (1.1)
#define PERIOD_CIRCLE_Ap_0 (1.05)
#define PERIOD_DESIRED_Ap_0 (1.05)
#define PERIOD_BAT_Ap_0 (1.1)
#define PERIOD_BARO_MS5534A_Ap_0 (1.4)
#define PERIOD_SCP_STATUS_Ap_0 (1.3)
...
#define PERIOD_DL_VALUE_Ap_0 (1.2)
...
#define PERIOD_IMU_GYRO_Ap_0 (.9)
#define PERIOD_IMU_MAG_Ap_0 (1.9)
...
#define PeriodicSendAp(_trans, _dev) {  /* 60Hz */ \
  if (telemetry_mode_Ap == TELEMETRY_MODE_Ap_default) {\
    ...
    static uint8_t i42 = 0; i42++; if (i42>=42) i42=0;\
    ...
    static uint8_t i114 = 0; i114++; if (i114>=114) i114=0;\
